...
自動テストは「機能があること」は見るが、「指で触って届くこと」までは見きれない。
実際にそれで2回、実機で動かないものを出した。

iPadで触って確かめる項目を **[`docs/iPadでの確認項目.md`](docs/iPadでの確認項目.md)** にまとめてある。
**最初に左下の版表示を確かめる**のが肝で、ここを飛ばすと
「古い版のせい」なのか「本当の不具合」なのか分からなくなる。

### デッキを組む

デッキ選択画面の **「🛠 デッキを組む」** から、37種類のカードで自分のデッキを組めます。

- **ちょうど40枚**、**同じ名前は3枚まで**
- ＋−は指で押せる大きさ。上限に達すると押せなくなります
- 「見本を入れる」で40枚をひとまず埋められます
- 組んだデッキは **「💾 データ」** から書き出せます
